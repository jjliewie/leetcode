...
<strong>Explanation:</strong> The words are "Hello" and "World", both of length 5.
</pre>
...
<strong>Explanation:</strong> The longest word is "moon" with length 4.
</pre>
...
<strong>Explanation:</strong> The longest word is "joyboy" with length 6.
</pre>
